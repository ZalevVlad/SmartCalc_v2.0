...
#include "ui_withdrawals_input.h"

withdrawals_input::withdrawals_input(QWidget* parent)
    : QDialog(parent), ui(new Ui::withdrawals_input) {
  ui->setupUi(this);
}

withdrawals_input::~withdrawals_input() { delete ui; }

void withdrawals_input::on_pushButton_add_clicked() {
  ui->tableWidget->insertRow(ui->tableWidget->rowCount());
}

void withdrawals_input::on_pushButton_del_clicked() {
...
void withdrawals_input::on_pushButton_save_clicked() {
  bool correct = 1;
